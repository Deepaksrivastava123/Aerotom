...
import com.aerotom.aerotom.model.ContryCode;
import com.aerotom.aerotom.model.LoginUser;
...
import static com.aerotom.aerotom.utils.Utility.isvarification;
...
//            jsonObject.put("email", edEmailnew.getText().toString());
//            jsonObject.put("mobile", edMobile.getText().toString());
//            jsonObject.put("password", edPassswordnew.getText().toString());
//            jsonObject.put("ccode","11111");
        ...
        try {
            ...
            if (callNo.equalsIgnoreCase("1")) {
                ...
                if (response.getResult().equals("true")) {
                    ...
                    startActivity(new Intent(this, VerifyPhoneActivity.class).putExtra("code", "+91").putExtra("phone", edMobile.getText().toString()));
                } else {
